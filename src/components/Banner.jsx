...
const Banner = () => {
  ...
  return (
    <section style={backgroundImageStyle } className="bg-black flex flex-start w-[100%] h-[75vh] text-white py-20">
      <div className="container 2xl:flex 2xl:justify-center 2xl:w-[100%] items-center 2xl:flex-col w-[40vw] mx-[5vw]">
